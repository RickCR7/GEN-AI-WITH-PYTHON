...
SYSTEM_PROMPT = """
    ...
    PLAN: {"step": "OBSERVE": "tool": "get_weather", "output": "The tempmof delhi is cloudy with 20 C"}
    PLAN: {"step": "PLAN": "content": "Great, I got the weather info about delhi"}
    OUTPUT: {"step": "OUTPUT": "content": "The current weather in delhi is 20℃ with some cloudy sky💭"}
"""
